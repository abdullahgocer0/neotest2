...
.menu-button {
    ...
    border: none;
    border-radius: 50%;
    box-shadow: 0 0 10px rgba(209, 193, 193, 0.1);
    cursor: pointer;
    z-index: 999;
...
.menu-hidden {
    right: -120px; /* Menü yarısı gizlenecek şekilde */
}

.menu-button-hidden {
    right: -30px; /* Menü butonu yarısı gizlenecek şekilde */
}
...
`, "",{"version":3,"sources":["webpack://./src/styles.css"],"names":[],"mappings":"AAAA;IACI,eAAe;IACf,YAAY;IACZ,WAAW;IACX,sBAAsB;IACtB,aAAa;IACb,sBAAsB;IACtB,uCAAuC;IACvC,aAAa;AACjB;AACA;IACI,eAAe;IACf,YAAY;IACZ,WAAW;IACX,WAAW;IACX,YAAY;IACZ,yBAAyB;IACzB,WAAW;IACX,YAAY;IACZ,kBAAkB;IAClB,6CAA6C;IAC7C,eAAe;IACf,YAAY;IACZ,yBAAyB;IACzB,YAAY;AAChB;;;AAGA;IACI,WAAW;IACX,YAAY;AAChB;;AAEA;IACI,aAAa;IACb,eAAe;IACf,YAAY;IACZ,WAAW;IACX,oCAAoC;IACpC,mBAAmB;IACnB,wCAAwC;IACxC,2BAA2B;IAC3B,mCAAmC;IACnC,aAAa;IACb,0CAA0C;IAC1C,aAAa;IACb,yBAAyB;IACzB,uBAAuB;AAC3B;;;;AAIA;IACI,aAAa,EAAE,mCAAmC;AACtD;;AAEA;IACI,YAAY,EAAE,0CAA0C;AAC5D;;AAEA;IACI,yBAAyB;IACzB,WAAW;IACX,YAAY;IACZ,kBAAkB;IAClB,eAAe;IACf,kBAAkB;IAClB,eAAe;AACnB;AACA;KACK,wBAAwB;AAC7B;;;AAGA;IACI,gBAAgB;IAChB,mBAAmB;IACnB,uBAAuB;AAC3B","sourcesContent":[".notification {\n    position: fixed;\n    bottom: 20px;\n    right: 20px;\n    background-color: #fff;\n    padding: 20px;\n    border: 1px solid #ccc;\n    box-shadow: 0 0 10px rgba(0, 0, 0, 0.1);\n    z-index: 1000;\n}\n.menu-button {\n    position: fixed;\n    bottom: 20px;\n    right: 20px;\n    width: 50px;\n    height: 50px;\n    background-color: #007bff;\n    color: #fff;\n    border: none;\n    border-radius: 50%;\n    box-shadow: 0 0 10px rgba(209, 193, 193, 0.1);\n    cursor: pointer;\n    z-index: 999;\n    transition: all 0.3s ease;\n    border: none;\n}\n\n\n.menu-button:hover {\n    width: 70px;\n    height: 70px;\n}\n\n.menu-content {\n    display: none;\n    position: fixed;\n    bottom: 80px;\n    right: 20px;\n    background: rgba(255, 255, 255, 0.2);\n    border-radius: 10px;\n    box-shadow: 0 4px 8px rgba(0, 0, 0, 0.1);\n    backdrop-filter: blur(10px);\n    -webkit-backdrop-filter: blur(10px);\n    padding: 10px;\n    border: 1px solid rgba(255, 255, 255, 0.3);\n    z-index: 1000;\n    transition: all 0.3s ease;\n    max-height: fit-content;\n}\n\n\n\n.menu-hidden {\n    right: -120px; /* Menü yarısı gizlenecek şekilde */\n}\n\n.menu-button-hidden {\n    right: -30px; /* Menü butonu yarısı gizlenecek şekilde */\n}\n\n.start-stop-button {\n    background-color: #007bff;\n    color: #fff;\n    border: none;\n    padding: 10px 20px;\n    cursor: pointer;\n    border-radius: 5px;\n    font-size: 16px;\n}\nbutton:focus, button:focus-visible {\n     outline: none !important;\n}\n\n\n.sessionId-label {\n    margin-top: 20px;\n    margin-bottom: 20px;\n    font-family: sans-serif;\n}\n"],"sourceRoot":""}]);
// Exports
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   attachGlobalListeners: () => (/* binding */ attachGlobalListeners),
/* harmony export */   detachGlobalListeners: () => (/* binding */ detachGlobalListeners),
/* harmony export */   fetchListeningParameter: () => (/* binding */ fetchListeningParameter),
/* harmony export */   generateEventDescription: () => (/* binding */ generateEventDescription),
/* harmony export */   generateEventSentence: () => (/* binding */ generateEventSentence),
/* harmony export */   generateSessionId: () => (/* binding */ generateSessionId),
/* harmony export */   getXPath: () => (/* binding */ getXPath),
/* harmony export */   initializeListeners: () => (/* binding */ initializeListeners),
/* harmony export */   initializeMenu: () => (/* binding */ initializeMenu),
/* harmony export */   setListeningParameter: () => (/* binding */ setListeningParameter),
/* harmony export */   showNotification: () => (/* binding */ showNotification),
/* harmony export */   showNotification2: () => (/* binding */ showNotification2)
/* harmony export */ });
...
function generateEventSentence(event) {
    const eventType = event.type;
    const elementType = event.target.tagName.toLowerCase();
    const elementId = event.target.id ? ` with id '${event.target.id}'` : '';
    const elementValue = event.target.value ? ` and value '${event.target.value}'` : event.target.innerText || '';
...
function generateEventDescription(event) {
    ...
    const elementValue = event.target.value || event.target.innerText || null;
    const elementClass = event.target.className || null;
    const timestamp = new Date().toISOString();
    const url = window.location.host;
    const pathX = getXPath(event.target);
...
function getXPath(element) {
    ...
    let ix = 0;
    const siblings = (_a = element.parentNode) === null || _a === void 0 ? void 0 : _a.childNodes;
    if (siblings) {
...
function handleEvent(event) {
    ...
    return __awaiter(this, void 0, void 0, function* () {
        ...
        if (target.id == ((_a = document.querySelector('#menuButton')) === null || _a === void 0 ? void 0 : _a.id)) {
            return;
        }
...
function attachGlobalListeners() {
    ...
    document.querySelectorAll('button').forEach(element => {
        var _a, _b;
        if (element.id !== ((_a = document.querySelector('#menuButton')) === null || _a === void 0 ? void 0 : _a.id) && element.id !== ((_b = document.querySelector('#startStopButton')) === null || _b === void 0 ? void 0 : _b.id)) {
...
function showNotification(message, onYes, onNo) {
    var _a, _b;
    ...
    if (!container) {
        ...
        (_a = container.querySelector('.yes')) === null || _a === void 0 ? void 0 : _a.addEventListener('click', () => {
            onYes();
            hideNotification();
        ...
        (_b = container.querySelector('.no')) === null || _b === void 0 ? void 0 : _b.addEventListener('click', () => {
            onNo();
            hideNotification();
        });
    }
...
function storeEventDescriptions() {
    setListeningParameter('https://neotest-701e1c076af2.herokuapp.com/api/count/finish/scenario', window.location.host);
}
function initializeListeners() {
    return __awaiter(this, void 0, void 0, function* () {
        // Uyarı mesajını göster
        showNotification('Test ortamındasın! Dinleme başlatılsın mı? Session-Id : ' + sessionId, () => __awaiter(this, void 0, void 0, function* () {
            yield setListeningParameter('https://neotest-701e1c076af2.herokuapp.com/api/count/start/scenario', window.location.host);
            yield paramListener();
        }), () => {
            setListeningParameter('https://neotest-701e1c076af2.herokuapp.com/api/count/finish/scenario', window.location.host);
        });
...
function paramListener() {
    return __awaiter(this, void 0, void 0, function* () {
        const shouldListen = yield fetchListeningParameter(window.location.host);
        if (shouldListen) {
...
function saveButtonPosition(top) {
    localStorage.setItem('menuButtonTop', top.toString());
}
function getButtonPosition() {
    const top = localStorage.getItem('menuButtonTop');
    return top ? parseInt(top, 10) : 20; // Default position
}
function initializeMenu() {
    ...
    menuButton.style.top = `${getButtonPosition()}px`;
    ...
    menuButton.addEventListener('click', () => {
        const topPosition = menuButton.getBoundingClientRect().top;
        menuContent.style.top = `${topPosition + menuButton.offsetHeight}px`;
    ...
    startStopButton.addEventListener('click', () => __awaiter(this, void 0, void 0, function* () {
        if (startStopButton.innerHTML.includes('Start')) {
            ...
            yield setListeningParameter('https://neotest-701e1c076af2.herokuapp.com/api/count/finish/scenario', window.location.host);
            yield paramListener();
            startStopButton.style.backgroundColor = 'green';
            startStopButton.innerHTML = '<i class="fas fa-play"></i><span style="margin-left:10px;"> Start</span>';
        }
    }));
    // Sürükle ve Bırak İşlevselliği Ekle
    ...
    menuButton.addEventListener('mousedown', (e) => {
        ...
        initialButtonY = menuButton.getBoundingClientRect().top;
    });
    document.addEventListener('mousemove', (e) => {
        if (isDragging) {
            ...
            if (newTop < 0)
                newTop = 0;
            if (newTop > window.innerHeight - menuButton.offsetHeight)
                newTop = window.innerHeight - menuButton.offsetHeight;
    ...
    document.addEventListener('mouseup', () => {
        if (isDragging) {
            isDragging = false;
            saveButtonPosition(parseInt(menuButton.style.top, 10));
        }
    });
}
